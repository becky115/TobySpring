...
@ContextConfiguration(locations="/ex6/_66/applicationContext.xml")
...
//		UserService txUserService = (UserService) txProxyFactoryBean.getObject();
	...
	static class TestUserServiceImpl extends UserServiceImpl {
		private String id = "madnite1"; // 테스트 픽스처의 users(3)의 id값 고정시킴
		
		protected void upgradeLevel(User user) { //UserService의 메소드를 오버라이드 한다.
			System.out.println("TestUserService upgradeLevel...... " + user.getId() +"," +(this.id));
